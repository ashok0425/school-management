...
<section class="body-wrapper">
            ...
            <div class="row">
                <div class="col-md-4 PlanBox BasicPlan">
                    ...
                    <div class="PlanBody">
                        ...
                        <div class="items"><i class="fa fa-check"></i> User management</div>
                        <div class="items"><i class="fa fa-check"></i> Admin Features Control </div>
                        <div class="items"><i class="fa fa-check"></i> Reporting </div>
                        <div class="items"><i class="fa fa-check"></i> Custom Personal Meeting </div>
                        <div class="text-center plan-buy-btn">
                            <button class="btn btn-basic btn-rounded">Buy Now</button>
                ...
                <div class="col-md-4 PlanBox StandardPlan">
                    ...
                    <div class="PlanBody">
                        ...
                        <div class="items"><i class="fa fa-check"></i> Reporting </div>
                        <div class="items"><i class="fa fa-check"></i> Custom Personal Meeting </div>
                        <div class="items"><i class="fa fa-check"></i> 1GB of MP4 or M4A cloud recording</div>
                        <div class="items"><i class="fa fa-check"></i> Skype for Business (Lync) interoperability</div>
                        <div class="items"><i class="fa fa-check"></i> Includes 100 participants</div>
                        <div class="items"><i class="fa fa-check"></i> User management</div>
                        <div class="items"><i class="fa fa-check"></i> Admin Features Control </div>
                        <div class="items"><i class="fa fa-check"></i> Reporting </div>
                        ...
                        <div class="items"><i class="fa fa-check"></i> Custom Personal Meeting </div>
                        <div class="text-center plan-buy-btn">
                            <button class="btn  btn-rounded">Buy Now</button>
    ...
    <!--Every Plan Includes starts herer-->
    <div class="AllPlan bg-off-white section-paddings">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 EveryPlan">
                    ...
                    <div class="items"><i class="fa fa-check"></i> File Locking </div>
                    <div class="items"><i class="fa fa-check"></i> SSL and At Rest </div>
                    <div class="items"><i class="fa fa-check"></i> Two factor Authentication</div>
                    <div class="items"><i class="fa fa-check"></i> Full Text Search </div>
                ...
                <div class="col-md-4 EveryPlan">
                    ...
                    <div class="items"><i class="fa fa-check"></i> File Locking </div>
                    <div class="items"><i class="fa fa-check"></i> SSL and At Rest </div>
                    <div class="items"><i class="fa fa-check"></i> ARich File Preview</div>
                    <div class="items"><i class="fa fa-check"></i> All Basic features </div>
                    <div class="items"><i class="fa fa-check"></i> Two factor Authentication</div>
                </div>
    ...
    <!--Every Plan Includes ends herer-->
