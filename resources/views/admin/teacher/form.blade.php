                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.teacher.save')}}" class="create-teacher" novalidate oninput='password_confirmation.setCustomValidity(password_confirmation.value != password.value ? "Password did not matched." : "")' enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="contact" class="form-control" id="contact" name="contact" placeholder="98******" required="true" value="{{old('contact')}}">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="youremail@mail.com" required="true" value="{{old('email')}}">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control cPassword" id="confirm-password" name="password_confirmation" placeholder="*****" required="true">
