...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.teacher.update',['user'=>$user->id])}}" class="create-teacher" novalidate oninput='password_confirmation.setCustomValidity(password_confirmation.value != password.value ? "Password did not matched." : "")' enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="contact" class="form-control" id="contact" name="contact" placeholder="98******" required="true" value="{{$user->contact}}">
                            <div class="invalid-feedback">
