...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
           ...
           @include('admin.layout.validation-error')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('school.section.save')}}" class="class" novalidate >
                    {{csrf_field()}}
                        <div class="form-group">
                            <label for="level">Section</label>
                            <input type="text" class="form-control" id="section" name="section" placeholder="Eneter Section" required="true" value="{{old('section')}}">
