           ...
           @include('admin.layout.validation-error')
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit School : {{$school->name}}</h6>
                </div>
                <div class="card-body">
                    <form method="post" action="{{route('admin.school.update',['school'=>$school->id])}}" class="class" novalidate enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <img id="preview_img" src="https://www.w3adda.com/wp-content/uploads/2019/09/No_Image-128.png" class="" width="100" height="100"/>
                            @endif
                        </div>
