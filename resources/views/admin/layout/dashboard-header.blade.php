...
{{--
            <li class="nav-item dropdown search- no-arrow d-sm-none">
                <a class="nav-link dropdown-toggle" href="#" id="searchDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
--}}
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-white small">{{Auth::guard('school')->user()->name}}</span>
                @if(isset(Auth::guard('school')->user()->logo))
                    <img class="img-profile rounded-circle" src="{{ asset('/storage') . '/' . Auth::guard('school')->user()->logo }}">
                @else
